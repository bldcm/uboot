...
tc16_config:	unconfig
	@./mkconfig $(@:_config=) ppc ppc4xx tc16 

tc18_config:	unconfig
	@./mkconfig $(@:_config=) ppc ppc4xx tc18 

tc18_ram_config:	unconfig
	@./mkconfig $(@:_config=) ppc ppc4xx tc18_ram 
