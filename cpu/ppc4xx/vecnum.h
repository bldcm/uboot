...
#define VECNUM_U0           0           /* UART0                        */
#define VECNUM_U1           1           /* UART1                        */
#define VECNUM_D0           3           /* DMA channel 0                */
#define VECNUM_D1           4           /* DMA channel 1                */
#define VECNUM_D2           5           /* DMA channel 2                */
#define VECNUM_D3           6           /* DMA channel 3                */

#define VECNUM_EWU0         41           /* Ethernet wakeup              */

#define VECNUM_MS           45          /* MAL SERR                     */
#define VECNUM_MTE          17          /* MAL TXEOB                    */
#define VECNUM_MRE          18          /* MAL RXEOB                    */
#define VECNUM_TXDE         46          /* MAL TXDE                     */
#define VECNUM_RXDE         47          /* MAL RXDE                     */

#define VECNUM_ETH0         37          /* Ethernet interrupt status    */
#define VECNUM_EIR0         21          /* External interrupt 0         */
#define VECNUM_EIR1         22          /* External interrupt 1         */
#define VECNUM_EIR2         23          /* External interrupt 2         */
#define VECNUM_EIR3         24          /* External interrupt 3         */
#define VECNUM_EIR4         25          /* External interrupt 4         */
#define VECNUM_EIR5         26          /* External interrupt 5         */
#define VECNUM_EIR6         27          /* External interrupt 6         */
