...
#define CPC0_PLLMR  0xf0                /* PLL mode register */
...
/* Bit definitions */
#define PLLMR_USES_PLL		0x80000000     /* if not set, uses SysClk
						  directly */

#define PLLMR_FWD_DIV_MASK      0x00070000     /* Forward Divisor */
#define PLLMR_FWD_DIV_BYPASS    0x00070000
#define PLLMR_FWD_DIV_3         0x00050000
#define PLLMR_FWD_DIV_4         0x00040000
#define PLLMR_FWD_DIV_6         0x00020000

#define PLLMR_FB_DIV_MASK       0x00f00000     /* Feedback Divisor */
#define PLLMR_FB_DIV_1          0x00100000
#define PLLMR_FB_DIV_2          0x00200000
#define PLLMR_FB_DIV_3          0x00300000
#define PLLMR_FB_DIV_4          0x00400000

#define PLLMR_TUNING_MASK       0x0000003f

#define PLLMR_CPU_TO_PLB_MASK   0x0c000000     /* CPU:PLB Frequency Divisor */
#define PLLMR_CPU_PLB_DIV_1     0x00000000
#define PLLMR_CPU_PLB_DIV_2     0x04000000
#define PLLMR_CPU_PLB_DIV_3     0x08000000
#define PLLMR_CPU_PLB_DIV_4     0x0c000000

#define PLLMR_OPB_TO_PLB_MASK   0x00000c00     /* OPB:PLB Frequency Divisor */
#define PLLMR_OPB_PLB_DIV_1     0x00000000
#define PLLMR_OPB_PLB_DIV_2     0x00000400
#define PLLMR_OPB_PLB_DIV_3     0x00000800
#define PLLMR_OPB_PLB_DIV_4     0x00000c00
...
#define PLLMR_EXB_TO_PLB_MASK   0x03000000     /* External Bus:PLB Divisor  */
#define PLLMR_EXB_PLB_DIV_2     0x00000000
#define PLLMR_EXB_PLB_DIV_3     0x01000000
#define PLLMR_EXB_PLB_DIV_4     0x02000000
#define PLLMR_EXB_PLB_DIV_5     0x03000000
