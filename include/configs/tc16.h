...
#define CFG_MONITOR_LEN         ((256+64) * 1024)    /* Reserve 192 kB for Monitor    (including .bss section) */
#define CFG_IMAGE_LEN           (256 * 1024)    /* But the image is only 128K */
#else
